...
export default function LLeeAIView() {
  ...
  const [messages, setMessages] = useState([{
    id: "welcome", role: "assistant", text: "안녕하세요. 자산, 일정, 할 일에 관해 궁금한 내용을 물어보세요.",
  }]);
  ...
  return (
    <section className="mx-auto flex min-h-[650px] max-w-5xl flex-col overflow-hidden rounded-xl border border-white/10 bg-white/[0.045] shadow-xl shadow-black/10 backdrop-blur-xl">
        ...
        <div className="flex items-start justify-between gap-4">
          <div className="flex items-center gap-3">
            ...
            <div>
              ...
              <p className="mt-1 text-sm leading-6 text-slate-400">워크스페이스 데이터를 읽고 일정, 자산, 할 일을 요약해드립니다.</p>
            </div>
          </div>
      ...
      <div className="border-t border-white/10 p-4 sm:p-5">
        ...
        <p className="mt-3 text-center text-[11px] text-slate-500">메모는 분석하지 않으며, 데이터 추가·수정·삭제는 수행하지 않습니다.</p>
      </div>
    </section>
  );
}
